        ...
        <div className="flex h-screen bg-gray-100">
            ...
            <div className="flex-1 flex flex-col pl-64">
                ...
                <div className="relative flex-1 p-6 overflow-y-auto">
                    <div className="absolute top-0 left-0 w-full min-h-full bg-cover bg-center" style={{ backgroundImage: "url('./groupes-bg.jpg')", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat" }}></div>
                    ...
                    <div className="relative z-20 flex justify-center items-center">
                        <div className="relative z-10 w-full max-w-5xl bg-white/95 shadow-xl rounded-3xl p-10 backdrop-blur-lg mt-12 border border-gray-200">
                            ...
                            <div className="flex justify-center space-x-6 mb-10">
                                <button onClick={() => setShowCreateGroupModal(true)} className="flex items-center px-8 py-4 bg-blue-600 text-white text-lg font-semibold rounded-xl shadow-md hover:bg-blue-700 transition duration-300">
                                    ➕ Créer un groupe
                                </button>
                                <button onClick={() => setShowJoinGroupModal(true)} className="flex items-center px-8 py-4 bg-gray-500 text-white text-lg font-semibold rounded-xl shadow-md hover:bg-gray-600 transition duration-300">
                                    🔗 Rejoindre un groupe
                                </button>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                {groups.length > 0 ? (
                                    groups.map((group) => (
                                        <div key={group.id} onClick={() => navigate(`/group/${group.name}`)} className="bg-white bg-opacity-90 rounded-xl p-6 shadow-md hover:shadow-xl cursor-pointer transition-all duration-300 transform hover:scale-105 border border-gray-200">
